...
// backend/src/ai.ts) so a tailor run's raw output parses reliably for the
// preview modal; older rows (marker-delimited or pre-Phase-4 flat text) fall
// back to their original parsing paths.
